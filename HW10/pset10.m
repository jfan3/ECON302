...
%z = [-4*sigmaZeta -2*sigmaZeta 0 2*sigmaZeta 4*sigmaZeta];
...
figure(2)
plot(1:T, yAvg, 1:T, yLamba,'--', 1:T, yZ, 'o-', 1:T, yE);
legend('Original', 'Lambda', 'Z', 'E')
xlabel('Time')
ylabel('Income')

figure(3)
plot(1:T, cAvg, 1:T, cLambda,'--', 1:T, cZ, 'o-', 1:T, cE);
legend('Original', 'Lambda', 'Z', 'E')
xlabel('Time')
ylabel('Consumption')

figure(4)
plot(1:T, aAvg, 1:T, aLambda,'--', 1:T, aZ, 'o-', 1:T, aE);
legend('Original', 'Lambda', 'Z', 'E')
xlabel('Time')
ylabel('Wealth')
